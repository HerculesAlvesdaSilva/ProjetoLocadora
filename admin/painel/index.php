...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <div class="wrapper">
            ...
            <div class="leftNav">
                <ul id="menu">
                    <li class="dash"><a href="http://projetofaculdade.epizy.com/admin/painel/" title="" class="active"><span>Painel</span></a></li>
        ...
        <div id="footer">
            <div class="wrapper">
                <span>Projeto Locadora 2020 - Todos direitos reservados</span>
            </div>
        </div>

<div id="pagina">
    ...
    if (isset($_SESSION['logado_cliente'])):
        ...
        <div id="opcoes_cliente">
            <a href="#" onclick="janelaAlterar(<?php echo $idCliente->clientes_id; ?>,'cliente')">Editar</a> - <a href="http://localhost/ProjetoLocadora/modulos/excluir/conta">Encerrar Conta</a>
        </div>
                    ...
                    if (empty($filmesLocados)):
                        ...
                        while ($fl->valid()):
                            ...
                            <tr class="lista_filmes_devolver">
                                ...
                                <td><a href="http://localhost/ProjetoLocadora/relocar/filme/<?php echo $fl->current()->filmes_slug; ?>/locacao/<?php echo $fl->current()->locados_id; ?>">Relocar</a></td>
                            </tr>

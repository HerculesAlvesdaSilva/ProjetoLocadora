...
<div class="genero">
    ...
    <ul>
        ...
        while ($c->valid()):
            ?>
            <li><a href="http://projetofaculdade.epizy.com/categoria/<?php echo $c->current()->categorias_slug; ?>"><?php echo $c->current()->categorias_nome; ?></a></li>
            <?php
            $c->next();
        endwhile;
        ?>
...
<div class="pesquisa">
    <h2>PESQUISAR</h2> 
    <form action="http://projetofaculdade.epizy.com/pesquisa" method="post">
...
<div class="login">
    ...
    <div id="form_login_sidebar">
        ...
        <?php else: ?>
            <a href="http://projetofaculdade.epizy.com/?logout=ok">Sair</a><br />
...
<div class="newslleter">
    ...
    <div id="form_newsletter_sidebar">
        <form action="http://projetofaculdade.epizy.com/modulos/cadastrar/newsletter" method="post">
...
<div class="opnioes">
    ...
    <div id="opinioes_sidebar">
        ...
        while ($o->valid()):
            ?>
            <p><a href="http://projetofaculdade.epizy.com/detalhes/filme/<?php echo $o->current()->filmes_slug; ?>"><?php echo resumeTexto($o->current()->comentarios_texto,55); ?></a> - <?php  echo $o->current()->filmes_nome; ?></p>
            <?php
            $o->next();
        endwhile;
        ?>

    ...
    if (!isset($_SESSION['logado_cliente'])):
        ...
        <div id="logar_cliente">
            ...
            <div id="logar">
                ...
                <form action="http://http://localhost/ProjetoLocadora/<?php echo basename($_SERVER['REQUEST_URI']); ?>" method="post">
            ...
            <div id="cadastrar">
                ...
                <p id="mensagem_cadastrar">
                    ...
                    <a href="http://http://localhost/ProjetoLocadora/cadastrar">CADASTRAR</a>
                </p>
            </div>
        </div>
        <?php

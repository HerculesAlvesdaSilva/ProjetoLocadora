        ...
        if (empty($filmes)):
            ...
            <div id="foto_descricao">
                ...
                <div id="foto_detalhes_filme">
                    <img src="http://http://localhost/ProjetoLocadora/<?php echo $filmes->filmes_foto_descricao; ?>" />
                    ...
                    <div id="botao_locar">
                        ...
                        if (!empty($locado)):
                            ?>
                            <img src="http://http://localhost/ProjetoLocadora/imagens/indisponivel_detalhes.jpg" />
                        <?php else: ?>                      
                            <a href="http://http://localhost/ProjetoLocadora/meus_filmes/filme/<?php echo $filmes->filmes_slug; ?>"><img src="http://http://localhost/ProjetoLocadora/imagens/locar_detalhes.jpg" /></a>
                        <?php endif; ?>
                    </div>
                    ...
                    if (!empty($sugestoes)):
                        ...
                        while ($s->valid()):
                            ...
                            <div class="filmes_categoria">
                                ...
                                <div class="foto_filme_categoria"><img src="http://http://localhost/ProjetoLocadora/<?php echo $s->current()->filmes_foto; ?>" /></div>
                                <div class="dados_filme">
                                    ...
                                    <a href="http://http://localhost/ProjetoLocadora/detalhes/filme/<?php echo $s->current()->filmes_slug; ?>" class="bt_detalhes">Detalhes</a> | 
                                    <?php
                                    if (!empty($verificaLocado)):
                                        ?>
                                        Filme Locado
                ...
                <div id="comentarios">
                                ...
                                <div class="foto_cliente">  
                                    <?php if (!empty($l->current()->clientes_foto)) { ?>
                                        ...
                                        <?php if (!is_file($l->current()->clientes_foto)): ?>
                                            <img src="http://http://localhost/ProjetoLocadora/fotos/clientes/sem_foto.jpg" />
                                        <?php else: ?>
                                            <img src="http://http://localhost/ProjetoLocadora/<?php echo $l->current()->clientes_foto; ?>" />
                                        <?php endif; ?>
                                    ...
                                    if (isset($_SESSION['logado_cliente'])):
                                        if (checkEdit($l->current()->clientes_id, $l->current()->comentarios_id)):
                                            ...
                                            if ($l->current()->clientes_id == $idCliente->clientes_id):
                                                ?>
                                                <a href="#" id="edit" data-id="<?php echo $l->current()->comentarios_id; ?>"><img src="http://http://localhost/ProjetoLocadora/imagens/edit.png" /></a> | <a href="#" id="deletar_comentario" data-id="<?php echo $l->current()->comentarios_id; ?>"><img src="http://http://localhost/ProjetoLocadora/imagens/delete.png" /></a>                                                         
                    ...
                    <div id="form_comentarios">
                        <?php if (isset($_SESSION['logado_cliente'])): ?>
                            <form action="http://http://localhost/ProjetoLocadora/modulos/cadastrar/comentarios" method="post">

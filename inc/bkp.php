                        ...
                        <table width="780" cellspacing="0">
                            ...
                            <tbody>
                                ...
                                while ($fm->valid()):
                                    ...
                                    <!--LISTAGEM DOS FILMES DO MES -->
                                    <tr class="tabela_filmes_locados">
                                        <td><img src="http://http://localhost/ProjetoLocadora/<?php echo $fm->current()->filmes_foto ?>" width="45" height="35" /></td>
            ...
            <div class="wrapper">
                <ul>
                    ...
                    while ($lan->valid()):
                        ?>
                        <li>
                            <a href="http://http://localhost/ProjetoLocadora/detalhes/<?php echo $lan->current()->filmes_slug; ?>"><img src="http://http://localhost/ProjetoLocadora/<?php echo $lan->current()->filmes_foto; ?>" width="80" height="90" alt="<?php echo $lan->current()->filmes_slug; ?>"/></a>
                            <br />
